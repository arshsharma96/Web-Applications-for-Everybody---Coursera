...
<p><h2>Automobiles</h2>
<?php
$stmt = $mysqlObj->getPDO()->query("SELECT * FROM autos");
$rows = $stmt->fetchAll(PDO::FETCH_ASSOC);
// TODO if no data in table no rows to be printed
// creating table
echo "<table border='1px solid black'><tr><th>Make</th><th>Model</th><th>Year</th><th>Mileage</th><th>Action</th></tr>";
foreach ( $rows as $row ) {
    echo "<tr>";
    ...
    echo '<td> <a href="edit.php?id='.$row['autos_id'].'">Edit</a> / ';
    echo  '<a href="delete.php?id='.$row['autos_id'].'">Delete</a></td>';
    echo "</tr>";
}
echo "</table>";
?>
